...
private:
	...
	//G4Isotope *Li6;
	G4MaterialPropertiesTable *mptNaI, *mptAir, *mptPVT, *mptAcrylic, *mptAl/*, *mptMuMetal, *mptMirror, *mptBeCuPhotoCath, *mptEJ200*/;
	...
	// divide by wavelength in nm to get energy in eV
